...
export type CloseInput<
  ...
  TAccountSolmarket extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountSolmarket>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountSolmarket> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.solmarket),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountSolmarket>;
